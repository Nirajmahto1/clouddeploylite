    ...
    <div className="login-page">
      <div className="login-container">
        <div className="login-header">
          ...
          <p>Deploy GitHub repos with one click</p>
        </div>
        ...
        <div className="login-content">
          ...
          <div className="login-features">
            <h3>Features:</h3>
            <ul>
              <li>✨ Auto-detect runtime (Node.js/Python)</li>
              <li>🐳 Automatic Docker containerization</li>
              <li>🌐 Custom subdomain for each app</li>
