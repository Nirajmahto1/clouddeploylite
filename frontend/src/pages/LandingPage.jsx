...
const css = `
  ...
  :root {
    ...
    --accent:#3b82f6; --accent2:#60a5fa; --green:#22c55e; --cyan:#06b6d4;
  ...
  *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
  ...
  .v-dots{display:flex;gap:6px;margin-bottom:16px;align-items:center}
  .v-dot{width:11px;height:11px;border-radius:50%}
  .v-url{flex:1;background:var(--surface2);border:1px solid var(--border2);border-radius:6px;padding:7px 12px;font-family:var(--mono);font-size:11px;color:var(--muted);margin-left:8px}
  ...
  @media(max-width:500px){.hero-title{font-size:28px}.landing{padding:0 16px 60px}}
`;
      ...
      <div className="landing fade-in">
        ...
        <section className="hero">
          <div>
            ...
            <p className="hero-sub">Just paste your GitHub URL. CloudDeployLite handles building, scaling, and SSL with zero configuration.</p>
            ...
            <div className="v-runtimes">
              {[["server","NODE.JS","#3b82f6"],["activity","REACT","#61dafb"],["cloud","DOCKER","#2496ed"]].map(([ic,lb,cl])=>(
                <div className="v-rt" key={lb}>
                  <div className="v-rt-icon" style={{background:cl+"1e"}}><Icon d={I[ic]} size={16} color={cl}/></div>
        ...
        <section className="section">
          ...
          <div className="features-grid">
            {[
              {icon:"zap",    col:"#8b5cf6",name:"Auto-detection of runtimes",desc:"We automatically identify your framework—be it Next.js, Django, or Go—and optimize the build process accordingly."},
              {icon:"shield", col:"#22c55e",name:"Subdomains with HTTPS",    desc:"Every single deployment gets a secure, custom subdomain with automated SSL certificates out of the box."},
              {icon:"activity",col:"#3b82f6",name:"Real-time build logs",    desc:"Monitor your deployment progress with live streaming logs, detailed analytics, and instant build failure alerts."},
            ].map(f=>(
              <div className="feat-card" key={f.name}>
                <div className="feat-icon" style={{background:f.col+"18"}}><Icon d={I[f.icon]} size={20} color={f.col}/></div>
        ...
        <footer className="footer">
          <div className="logo">
            <div className="logo-icon" style={{width:24,height:24,borderRadius:6}}><Icon d={I.cloud} size={13} color="#fff"/></div>
